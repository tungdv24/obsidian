...
**Các loại Proxy**
1. **Forward Proxy**: Proxy giữa người dùng và internet, thường dùng để bảo mật và lọc nội dung. Nó thường được sử dụng để chuyển tiếp từ mạng nội bộ ra bên ngoài. Thông thường, **Proxy** có thể giúp người dùng truy cập các trang web bị chặn ở một quốc gia bằng các sử dụng mạng ở quốc gia khác.
2. **Reverse Proxy**: Proxy giữa người dùng bên ngoài và máy chủ nội bộ, thường để phân phối lưu lượng đến nhiều máy chủ nội bộ
